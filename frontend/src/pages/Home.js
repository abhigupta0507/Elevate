      ...
      <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
          <div class="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
            ...
            At Elevate, we’re dedicated to empowering your fitness journey. Our mission is to provide personalized workout plans, nutritious guidance, and a supportive community to help you achieve your goals.
            </p>
